...
class ItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create item" do
    assert_difference("Item.count") do
      post items_url, params: { item: { observacoes: @item.observacoes, pedido_id: @item.pedido_id, preco_unitario: @item.preco_unitario, produto_id: @item.produto_id, quantidade: @item.quantidade, subtotal: @item.subtotal } }
    end
