...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference("Venda.count") do
      post vendas_url, params: { venda: { cliente: @venda.cliente, data: @venda.data, hora: @venda.hora, status: @venda.status } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { cliente: @venda.cliente, data: @venda.data, hora: @venda.hora, status: @venda.status } }
