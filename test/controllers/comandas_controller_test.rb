...
class ComandasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comanda" do
    assert_difference("Comanda.count") do
      post comandas_url, params: { comanda: { numero: @comanda.numero, total: @comanda.total } }
    end
  ...
  test "should update comanda" do
    patch comanda_url(@comanda), params: { comanda: { numero: @comanda.numero, total: @comanda.total } }
